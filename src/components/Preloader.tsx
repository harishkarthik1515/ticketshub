...
const Preloader: React.FC<PreloaderProps> = ({ onComplete }) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 bg-black overflow-hidden transition-all duration-1000 ease-in-out ${
        ...
        <div className="text-center px-4">
          ...
          <div className={`mb-10 transition-all duration-1500 ease-out ${
            ...
            <div className="relative group">
              {/* Enhanced Logo Glow */}
              <div className="absolute -inset-4 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 rounded-3xl blur-2xl opacity-60 group-hover:opacity-80 transition-opacity duration-1000 animate-pulse" />
              
              {/* Logo Container */}
              <div className="relative bg-gradient-to-br from-purple-600 via-purple-700 to-pink-600 p-8 rounded-3xl shadow-2xl border border-purple-400/30">
          ...
          <div className={`w-96 max-w-sm mx-auto transition-all duration-1000 ease-out ${
            ...
            <div className="relative mb-6">
              ...
              <div className="h-3 bg-gray-800/60 rounded-full overflow-hidden backdrop-blur-sm border border-gray-700/50">
                {/* Progress Bar Fill */}
                <div 
              ...
              {/* Progress Glow */}
              <div 
                className="absolute top-0 h-3 bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 rounded-full blur-md opacity-60 transition-all duration-300 ease-out"
                style={{ width: `${progress}%` }}
              />
            </div>
            ...
            <div className="flex justify-between items-center text-gray-400">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-mono text-lg font-bold text-purple-300">{Math.round(progress)}%</span>
                {progress === 100 && (
      ...
      {isExiting && (
        <div className="absolute inset-0 bg-gradient-to-b from-black via-purple-900/20 to-black animate-fade-out" />
      )}
