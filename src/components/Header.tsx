    ...
    <>
        ...
        <div className={`transition-all duration-300 ease-out ${
          ...
          <div className={`flex items-center justify-between transition-all duration-300 ${
            ...
            {!isScrolled && (
              <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
                <button 
                  ...
                  className="text-gray-700 hover:text-purple-600 transition-colors duration-200 font-medium text-sm xl:text-base"
                >
                  Movies
                </button>
                <button 
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
              ...
              <div className={`relative transition-all duration-300 hidden md:block ${
                isSearchFocused 
                  ? 'w-56 lg:w-64' 
                  : isScrolled 
                    ? 'w-24 lg:w-32' 
                ...
                <input
                  ...
                  className={`block w-full border rounded-lg transition-all duration-200 ${
                    isScrolled 
                      ? 'pl-7 sm:pl-8 pr-2 sm:pr-3 py-1 text-xs border-gray-200 focus:ring-1 focus:ring-purple-500 focus:border-transparent bg-white' 
                      : 'pl-8 sm:pl-9 pr-2 sm:pr-3 py-1.5 sm:py-2 text-xs sm:text-sm border-gray-200 focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white'
                  }`}
              ...
              {!isScrolled && (
                <div className="hidden xl:flex items-center space-x-2 text-gray-700 hover:text-purple-600 cursor-pointer transition-colors duration-200">
              ...
              <button 
                ...
                className={`flex items-center space-x-1 sm:space-x-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-200 hover:scale-105 ${
                  isScrolled 
              ...
              >
                {isAuthenticated && user?.avatar ? (
                  ...
                  <User className={`${isScrolled ? 'w-3 h-3 sm:w-4 sm:h-4' : 'w-4 h-4 sm:w-5 sm:h-5'}`} />
                )}
                {!isScrolled && (
                  <span className="font-medium hidden sm:block text-xs sm:text-sm">
              ...
              {/* Mobile Menu Button */}
              <button
                className={`lg:hidden p-1.5 sm:p-2 rounded-lg transition-colors duration-200 hover:bg-gray-100 text-gray-700 mobile-menu-container ${
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          {/* Menu Panel */}
          <div className="fixed top-0 right-0 h-full w-full max-w-sm bg-white shadow-2xl mobile-menu-container">
