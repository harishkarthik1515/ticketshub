...
const Categories = () => {
  ...
  return (
    <section id="categories-section" className="py-20 bg-gradient-to-b from-white to-gray-50/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover amazing experiences across all your favorite entertainment categories
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {categories.slice(0, 4).map((category, index) => {
              ...
              return (
                ...
                >
                  <div className={`${category.bgColor} ${category.hoverBg} rounded-3xl p-6 text-center 
                    ...
                    {/* Icon Container */}
                    <div className={`relative w-14 h-14 mx-auto mb-4 bg-gradient-to-r ${category.color} 
                      ...
                      {/* Glow Effect */}
                      <div className={`absolute inset-0 bg-gradient-to-r ${category.color} rounded-2xl 
        ...
        <div className="text-center mt-16">
          <button 
            ...
            text-white font-semibold rounded-2xl hover:from-purple-700 hover:to-pink-700 
            transform hover:scale-105 transition-all duration-200 shadow-xl hover:shadow-2xl group"
          >
            <span>Explore All Categories</span>
            <svg className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform duration-200" 
