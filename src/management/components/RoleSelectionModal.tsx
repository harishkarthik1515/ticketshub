          ...
          {roles.map((role) => {
            ...
            return (
              <div
                ...
                className={`${role.bgColor} rounded-2xl p-6 cursor-pointer hover:shadow-xl transition-all duration-300 hover:scale-105 border-2 border-transparent hover:border-gray-200 group`}
              >
